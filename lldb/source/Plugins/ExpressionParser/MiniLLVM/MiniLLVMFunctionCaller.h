...
class MiniLLVMFunctionCallerExpressionParser;
#endif

/// \class MiniLLVMFunctionCaller MiniLLVMFunctionCaller.h
...
/// struct with the written arguments.  This method lets MiniLLVM handle the
/// vagaries of function calling conventions.
///
/// The simplest use of the MiniLLVMFunctionCaller is to construct it with a
...
class MiniLLVMFunctionCaller : public FunctionCaller {
  friend class ASTStructExtractor;

  friend MiniLLVMFunctionCallerExpressionParser;
